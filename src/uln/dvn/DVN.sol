...
import { ILayerZeroUltraLightNodeV2 } from "../../l0labs/lz-evm-v1-0.7/contracts/interfaces/ILayerZeroUltraLightNodeV2.sol";
...
contract DVN is Worker, MultiSig, IDVN {
    ...
    constructor(
        ...
        Worker(_messageLibs, _priceFeed, 12_000, address(0x0), _admins)
    ...
    /// @dev if any of the instructions fail, it will emit an error event and continue to execute the rest of the
    /// instructions
    ...
    /// @dev for example, some administrative functions like changing signers, the contract should check hash to double
    /// spending
    ...
    function _shouldCheckHash(bytes4 _functionSig) internal pure returns (bool) {
        ...
        return _functionSig != IReceiveUlnE2.verify.selector // 0x0223536e, replaying won't change the state
            && _functionSig != ILayerZeroUltraLightNodeV2.updateHash.selector; // 0x704316e5, replaying will be revert at
            // uln
    }
}
